...
mixin _$PaymentMethodFailure {
  ...
  @JsonKey(ignore: true)
  $PaymentMethodFailureCopyWith<PaymentMethodFailure> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class __$$ServerImplCopyWithImpl<$Res>
    extends _$PaymentMethodFailureCopyWithImpl<$Res, _$ServerImpl>
...
class _$ServerImpl extends _Server {
  ...
  @override
  String toString() {
    return 'PaymentMethodFailure.server(message: $message)';
  }
...
abstract class _Server extends PaymentMethodFailure {
