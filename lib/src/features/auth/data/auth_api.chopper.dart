...
final class _$AuthApi extends AuthApi {
  ...
  Future<Response<Map<String, dynamic>>> signUp(
    ...
    final Uri $url = Uri.parse('http://192.168.10.170:8080/api/v1/users');
  ...
  Future<Response<Map<String, dynamic>>> signIn(
      {required Map<String, dynamic> data}) {
    final Uri $url = Uri.parse('http://192.168.10.170:8080/api/v1/users/login');
    final Map<String, String> $headers = {
      'Content-Type': 'application/json',
    };
    final $body = data;
  ...
  Future<Response<Map<String, dynamic>>> renewAccessToken({
    ...
    final Uri $url =
        Uri.parse('http://192.168.10.170:8080/api/v1/auth/access-token');
    final Map<String, String> $headers = {
...
final class _$AuthApi2 extends AuthApi2 {
  ...
  Future<Response<void>> signOut({
    ...
    final Uri $url =
        Uri.parse('http://192.168.10.170:8080/usr/v1/users/${userId}/logout');
    final Map<String, String> $headers = {
      'Authorization': accessToken,
      'Content-Type': 'application/json',
    };
