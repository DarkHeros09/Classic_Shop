...
final class _$WishListApi extends WishListApi {
  ...
  Future<Response<List<Map<String, dynamic>>>> getWishListItems({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.104:8080/usr/v1/users/${userId}/wish-lists/items');
  ...
  Future<Response<Map<String, dynamic>>> createWishListItem({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.104:8080/usr/v1/users/${userId}/wish-lists/${wishListId}/items');
    final $body = data;
    final Request $request = Request(
      'POST',
      $url,
  ...
  Future<Response<Map<String, dynamic>>> updateWishListItem({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.104:8080/usr/v1/users/${userId}/wish-lists/${wishListId}/items/${wishListItemId}');
    final $body = data;
    final Request $request = Request(
      'PUT',
      $url,
  ...
  Future<Response<Map<String, dynamic>>> deleteAllWishListItems({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.104:8080/usr/v1/users/${userId}/wish-lists/${wishListId}');
    final Request $request = Request(
      'DELETE',
      $url,
      client.baseUrl,
