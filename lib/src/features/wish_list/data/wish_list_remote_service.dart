...
class WishListRemoteService implements IWishListRemoteService {
  ...
  Future<RemoteResponse<WishListItemDTO>> createWishListItem({
    ...
    try {
      ...
      return RemoteResponse.withNewData(shopWishListItemDTO, maxPage: 0);
    } on SocketException {
      return const RemoteResponse.noConnection();
    }
  }
  ...
  Future<RemoteResponse<bool>> deleteAllWishListItems({
    ...
    try {
      ...
      return const RemoteResponse.withNewData(false, maxPage: 0);
    } on SocketException {
      return const RemoteResponse.noConnection();
    }
  }
  ...
  Future<RemoteResponse<bool>> deleteWishListItem({
    ...
    try {
      ...
      return const RemoteResponse.withNewData(true, maxPage: 0);
    } on SocketException {
      return const RemoteResponse.noConnection();
    }
  }
