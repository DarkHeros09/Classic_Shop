...
class _$_WishListItem implements _WishListItem {
  ...
  @override
  String toString() {
    return 'WishListItem(id: $id, wishListId: $wishListId, productItemId: $productItemId, name: $name, productImage: $productImage, price: $price, active: $active, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _WishListItem implements WishListItem {
  const factory _WishListItem(
      ...
      required final DateTime? updatedAt}) = _$_WishListItem;
