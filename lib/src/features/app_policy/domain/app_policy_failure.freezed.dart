...
part of 'app_policy_failure.dart';
...
/// @nodoc
abstract class $AppPolicyFailureCopyWith<$Res> {
  factory $AppPolicyFailureCopyWith(
          AppPolicyFailure value, $Res Function(AppPolicyFailure) then) =
      _$AppPolicyFailureCopyWithImpl<$Res, AppPolicyFailure>;
}

/// @nodoc
class _$AppPolicyFailureCopyWithImpl<$Res, $Val extends AppPolicyFailure>
    implements $AppPolicyFailureCopyWith<$Res> {
  _$AppPolicyFailureCopyWithImpl(this._value, this._then);
  ...
  /// Create a copy of AppPolicyFailure
...
class __$$ServerImplCopyWithImpl<$Res>
    extends _$AppPolicyFailureCopyWithImpl<$Res, _$ServerImpl>
...
class _$ServerImpl extends _Server {
  ...
  @override
  String toString() {
    return 'AppPolicyFailure.server(message: $message)';
  }
...
abstract class _Server extends AppPolicyFailure {
...
class __$$StorageImplCopyWithImpl<$Res>
    extends _$AppPolicyFailureCopyWithImpl<$Res, _$StorageImpl>
...
class _$StorageImpl extends _Storage {
  ...
  @override
  String toString() {
    return 'AppPolicyFailure.storage()';
  }
...
abstract class _Storage extends AppPolicyFailure {
