...
/// @nodoc
abstract class _$$_ShopCartItemDTOCopyWith<$Res>
    implements $ShopCartItemDTOCopyWith<$Res> {
  factory _$$_ShopCartItemDTOCopyWith(
          _$_ShopCartItemDTO value, $Res Function(_$_ShopCartItemDTO) then) =
      __$$_ShopCartItemDTOCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$_ShopCartItemDTOCopyWithImpl<$Res>
    extends _$ShopCartItemDTOCopyWithImpl<$Res, _$_ShopCartItemDTO>
    implements _$$_ShopCartItemDTOCopyWith<$Res> {
  __$$_ShopCartItemDTOCopyWithImpl(
      _$_ShopCartItemDTO _value, $Res Function(_$_ShopCartItemDTO) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_ShopCartItemDTO(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$_ShopCartItemDTO extends _ShopCartItemDTO {
  const _$_ShopCartItemDTO(
      {required this.id,
  ...
  factory _$_ShopCartItemDTO.fromJson(Map<String, dynamic> json) =>
      _$$_ShopCartItemDTOFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_ShopCartItemDTOCopyWith<_$_ShopCartItemDTO> get copyWith =>
      __$$_ShopCartItemDTOCopyWithImpl<_$_ShopCartItemDTO>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ShopCartItemDTOToJson(
      this,
    );
  }
}
