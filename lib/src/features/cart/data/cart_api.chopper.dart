...
final class _$CartApi extends CartApi {
  ...
  Future<Response<List<Map<String, dynamic>>>> getCartItems({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.105:8080/usr/v1/users/${userId}/carts/items');
  ...
  Future<Response<Map<String, dynamic>>> createCartItem({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.105:8080/usr/v1/users/${userId}/carts/${cartId}/items');
    final $body = data;
    final Request $request = Request(
      'POST',
      $url,
  ...
  Future<Response<Map<String, dynamic>>> updateCartItem({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.105:8080/usr/v1/users/${userId}/carts/${cartId}/items/${shoppingCartItemId}');
    final $body = data;
    final Request $request = Request(
      'PUT',
      $url,
  ...
  Future<Response<Map<String, dynamic>>> deleteAllCartItems({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.105:8080/usr/v1/users/${userId}/carts/${cartId}');
    final Request $request = Request(
      'DELETE',
      $url,
      client.baseUrl,
