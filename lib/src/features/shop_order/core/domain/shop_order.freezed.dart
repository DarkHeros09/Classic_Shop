...
/// @nodoc
abstract class _$$_ShopOrderCopyWith<$Res> implements $ShopOrderCopyWith<$Res> {
  factory _$$_ShopOrderCopyWith(
          _$_ShopOrder value, $Res Function(_$_ShopOrder) then) =
      __$$_ShopOrderCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$_ShopOrderCopyWithImpl<$Res>
    extends _$ShopOrderCopyWithImpl<$Res, _$_ShopOrder>
    implements _$$_ShopOrderCopyWith<$Res> {
  __$$_ShopOrderCopyWithImpl(
      _$_ShopOrder _value, $Res Function(_$_ShopOrder) _then)
      : super(_value, _then);
...
class _$_ShopOrder extends _ShopOrder {
  const _$_ShopOrder(
      {required this.id,
  ...
  @override
  String toString() {
    return 'ShopOrder(id: $id, orderNumber: $orderNumber, trackNumber: $trackNumber, userId: $userId, paymentMethodId: $paymentMethodId, shippingAddressId: $shippingAddressId, orderTotal: $orderTotal, deliveryMethodId: $deliveryMethodId, orderStatusId: $orderStatusId, status: $status, itemCount: $itemCount, createdAt: $createdAt)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_ShopOrderCopyWith<_$_ShopOrder> get copyWith =>
      __$$_ShopOrderCopyWithImpl<_$_ShopOrder>(this, _$identity);
}
...
abstract class _ShopOrder extends ShopOrder {
  const factory _ShopOrder(
      ...
      required final DateTime createdAt}) = _$_ShopOrder;
