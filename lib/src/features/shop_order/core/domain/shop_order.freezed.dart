...
// required final int paymentMethodId,
  ...
  @override
  String toString() {
    return 'ShopOrder(id: $id, orderNumber: $orderNumber, trackNumber: $trackNumber, userId: $userId, shippingAddressId: $shippingAddressId, orderTotal: $orderTotal, deliveryMethodId: $deliveryMethodId, orderStatusId: $orderStatusId, status: $status, itemCount: $itemCount, createdAt: $createdAt)';
  }
...
abstract class _ShopOrder extends ShopOrder {
  const factory _ShopOrder(
      ...
      required final DateTime createdAt}) = _$ShopOrderImpl;
