...
final class _$ShopOrderApi extends ShopOrderApi {
  ...
  Future<Response<List<Map<String, dynamic>>>> listShopOrders({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.101:8080/usr/v1/users/${userId}/shop-orders');
  ...
  Future<Response<List<Map<String, dynamic>>>> listShopOrdersV2({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.101:8080/usr/v1/users/${userId}/shop-orders-v2');
    final Map<String, dynamic> $params = <String, dynamic>{
      'limit': pageSize,
  ...
  Future<Response<List<Map<String, dynamic>>>> listShopOrdersNextPage({
    ...
    final Uri $url = Uri.parse(
        'http://192.168.1.101:8080/usr/v1/users/${userId}/shop-orders-next-page');
    final Map<String, dynamic> $params = <String, dynamic>{
      'cursor': lastItemId,
      'limit': pageSize,
      'order_status': orderStatus,
